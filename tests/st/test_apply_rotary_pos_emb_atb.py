...
# ============================================================================
"""Tests for ms_custom_ops.apply_rotary_pos_emb_atb using numpy golden reference."""
...
class AsdOpApplyRotaryPosEmbATBNet(nn.Cell):
    """apply_rotary_pos_emb_atb"""
    @jit_for_graph_mode
    def construct(self, query, key, cos, sin, seq_len, rotary_coeff, cos_format=0):
        return ms_custom_ops.apply_rotary_pos_emb_atb(query, key, cos, sin, seq_len, rotary_coeff, cos_format)
...
def run_case(query_dtype, cos_dtype, rotary_coeff, batch, seqlen, head_num_q, head_num_k, head_size):
    ...
    cos_format = 0
    net = AsdOpApplyRotaryPosEmbATBNet()
...
def test_asdop_rope_fp16(exec_mode, query_dtype, cos_dtype, rotary_coeff, batch, seqlen, head_num_q, head_num_k,
                         head_size):
    """
    Feature:  asdop apply_rotary_pos_emb_atb kernel.
    Description: test for apply_rotary_pos_emb_atb ops.
