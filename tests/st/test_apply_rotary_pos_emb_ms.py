...
def test_apply_rotary_pos_emb_ms_interleave(exec_mode, query_dtype, layout, rotary_mode, tokens, head_num_q,
                                            head_num_k, head_dim):
    """
...
def test_apply_rotary_pos_emb_ms_interleave_split(exec_mode, query_dtype, layout, rotary_mode, tokens, head_num_q,
                                                  head_num_k, head_dim, rotary_dim):
    """
    Feature: aclnnApplyRotaryPosEmb kernel.
    Description: test for ApplyRotaryPosEmb ops.
    Expectation:should pass for all testcases.
