...
def arg_mark(plat_marks, level_mark, card_mark, essential_mark):
    """
    Decorator generator for adding platform, level, card count, and essentiality marks to test functions.
    
    Args:
        plat_marks (list): List of platform marks, optional values are in optional_plat_marks
        level_mark (str): Test level mark, optional values are in optional_level_marks
        card_mark (str): Card count mark, optional values are in optional_card_marks
        essential_mark (str): Essentiality mark, optional values are in optional_essential_marks
    
    Returns:
        function: Decorator function for adding pytest marks
        
    Raises:
        ValueError: When the provided mark values are not within the optional values range
    """
