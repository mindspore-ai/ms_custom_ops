 ...
 */
#ifndef MS_CUSTOM_OPS_OP_DEF_ACLNN_PYBOOST_ACLNN_PYBOOST_RUNNER_H_
...
using AclnnLaunchFunc =
    std::function<void(mindspore::device::DeviceContext *, size_t)>;

class AclnnLaunchFunc final : public PyboostRunner {
public:
...
#endif // MS_CUSTOM_OPS_OP_DEF_ACLNN_PYBOOST_ACLNN_PYBOOST_RUNNER_H_
