...
class ApplyRotaryPosEmbV3Ascend : public AclnnCustomKernelMod {
 public:
  ...
  void GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
    ...
    auto layout_str = inputs[static_cast<size_t>(ApplyRotaryPosEmbV3InputIndex::kApplyRotaryPosEmbV3LayoutIndex)]
...
namespace ms_custom_ops {
void npu_apply_rotary_pos_emb_v3(const ms::Tensor &query, const ms::Tensor &key, const ms::Tensor &cos,
...
auto pyboost_apply_rotary_pos_emb_v3(const ms::Tensor &query, const ms::Tensor &key, const ms::Tensor &cos,
                                     const ms::Tensor &sin, const std::string &layout_str,
                                     const std::string &rotary_mode) {
  return ms::pynative::PyboostRunner::Call<ms_custom_ops::kNumber0>(ms_custom_ops::npu_apply_rotary_pos_emb_v3, query,
                                                                    key, cos, sin, layout_str, rotary_mode);
}

MS_CUSTOM_OPS_EXTENSION_MODULE(m) {
  m.def("apply_rotary_pos_emb_v3", &pyboost_apply_rotary_pos_emb_v3, "ApplyRotaryPosEmbV3", pybind11::arg("query"),
