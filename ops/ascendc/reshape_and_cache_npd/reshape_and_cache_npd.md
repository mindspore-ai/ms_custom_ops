...
| key_cache        | Tensor[float16/bfloat16]  | NPD: (BN, N, P, D); ND: (BN, P, N, D)| No       | ND     | key cache |
| value_cache      | Tensor[float16/bfloat16]  | NPD: (BN, N, P, D); ND: (BN, P, N, D)| No       | ND     | value cache |
...
|-----------|--------------------------|-------------------------------------------|---------------|
| key_out   | Tensor[float16/bfloat16] | NPD:(T+History, N * P * D) TH: (T, N * D) | key output    |
| value_out | Tensor[float16/bfloat16] | NPD:(T+History, N * P * D) TH: (T, N * D) | value output  |
