 ...
 */
#ifndef __OPS_ASCENDC_ACLNN_SRC_APPLY_ROTARY_POS_EMB_MS_APPLY_ROTARY_POS_EMB_MS_TILING_H__
#define __OPS_ASCENDC_ACLNN_SRC_APPLY_ROTARY_POS_EMB_MS_APPLY_ROTARY_POS_EMB_MS_TILING_H__
#include "register/tilingdata_base.h"

namespace optiling {
BEGIN_TILING_DATA_DEF(ApplyRotaryPosEmbMSTilingData)
...
REGISTER_TILING_DATA_CLASS(ApplyRotaryPosEmbMS, ApplyRotaryPosEmbMSTilingData)
}  // namespace optiling
#endif  // __OPS_ASCENDC_ACLNN_SRC_APPLY_ROTARY_POS_EMB_MS_APPLY_ROTARY_POS_EMB_MS_TILING_H__
