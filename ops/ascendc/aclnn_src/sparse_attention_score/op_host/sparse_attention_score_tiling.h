...
/*!
 * \file sparse_attention_score_tiling.h
 * \brief
 */
...
BEGIN_TILING_DATA_DEF(SparseAttentionScoreEmptyInputTilingData)
TILING_DATA_FIELD_DEF(uint32_t, coreNum);
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(SparseAttentionScoreEmptyInputTilingDataOp, SparseAttentionScoreEmptyInputTilingData)
...
TILING_DATA_FIELD_DEF(uint32_t, selectBlockLen);  /// 每个选择块的长度
TILING_DATA_FIELD_DEF(uint32_t, selectBlockNum);  /// 每个s1o选择几个选择块
END_TILING_DATA_DEF;
...
TILING_DATA_FIELD_DEF_STRUCT(SoftMaxTiling, softmaxSparseTilingData);
TILING_DATA_FIELD_DEF_STRUCT(SoftMaxTiling, softmaxTilingDataTailCore);
TILING_DATA_FIELD_DEF_STRUCT(SoftMaxTiling, softmaxSparseTilingDataTailCore);
...
TILING_DATA_FIELD_DEF_STRUCT(SparseAttentionScoreEmptyInputTilingData, emptyInputTilingData);
END_TILING_DATA_DEF;

BEGIN_TILING_DATA_DEF(SparseAttentionScoreGeneralTilingData)
...
REGISTER_TILING_DATA_CLASS(SparseAttentionScore_90, SparseAttentionScoreTilingData)
REGISTER_TILING_DATA_CLASS(SparseAttentionScore_92, SparseAttentionScoreTilingData)
REGISTER_TILING_DATA_CLASS(SparseAttentionScore_94, SparseAttentionScoreTilingData)
REGISTER_TILING_DATA_CLASS(SparseAttentionScore, SparseAttentionScoreGeneralTilingData)
