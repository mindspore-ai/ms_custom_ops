...
/*!
 * \file sparse_attention_score_proto.cpp
 * \brief
 */
...
ge::graphStatus InferShapeSparseAttentionScore(gert::InferShapeContext *context) {
  OPS_LOG_I(context, "Enter SparseAttentionScore runtime infershape impl.");
