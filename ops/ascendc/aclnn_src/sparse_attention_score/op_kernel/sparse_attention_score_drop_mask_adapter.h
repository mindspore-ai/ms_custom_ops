...
/*!
 * \file sparse_attention_score_drop_mask_adapter.h
 * \brief
 */

#ifndef SPARSE_ATTENTION_SCORE_DROP_MASK_ADAPTER_H
#define SPARSE_ATTENTION_SCORE_DROP_MASK_ADAPTER_H

#include "kernel_operator.h"
#include "kernel_tiling/kernel_tiling.h"

class SparseAttentionScoreDropMaskAdapter {
 public:
  __aicore__ inline SparseAttentionScoreDropMaskAdapter() {}
  __aicore__ inline void Init(__gm__ uint8_t *dropMask, __gm__ uint8_t *workspace,
                              const SparseAttentionScoreGeneralTilingData *__restrict tiling, AscendC::TPipe *tPipe);
...
__aicore__ inline void SparseAttentionScoreDropMaskAdapter::Init(
  __gm__ uint8_t *dropMask, __gm__ uint8_t *workspace, const SparseAttentionScoreGeneralTilingData *__restrict tiling,
  AscendC::TPipe *tPipe) {
  pipe = tPipe;
  tilingData = tiling;
...
__aicore__ inline void SparseAttentionScoreDropMaskAdapter::Process() {
...
__aicore__ inline void SparseAttentionScoreDropMaskAdapter::CopyIn(int64_t offset, int32_t calSize) {
...
__aicore__ inline void SparseAttentionScoreDropMaskAdapter::Compute(
...
__aicore__ inline void SparseAttentionScoreDropMaskAdapter::CopyOut(int64_t offset, int32_t calSize) {
...
__aicore__ inline void SparseAttentionScoreDropMaskAdapter::SyncAllCores() { AscendC::SyncAll(); }

#endif  // SPARSE_ATTENTION_SCORE_DROP_MASK_ADAPTER_H
