...
/*!
 * \file sparse_attention_score_bn2gs1s2_b.h
 * \brief
 */

#ifndef SPARSE_ATTENTION_SCORE_BN2GS1S2_B_H
#define SPARSE_ATTENTION_SCORE_BN2GS1S2_B_H
...
class SparseAttentionScoreBn2gs1s2B {
 public:
  __aicore__ inline SparseAttentionScoreBn2gs1s2B() {}
...
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock, layout>::Init(
  __gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *pse, __gm__ uint8_t *dropMask,
  __gm__ uint8_t *paddingMask, __gm__ uint8_t *prefix, __gm__ uint8_t *attenMask, __gm__ uint8_t *selectBlockIdx,
  __gm__ uint8_t *softmaxMax, __gm__ uint8_t *softmaxSum, __gm__ uint8_t *softmaxOut, __gm__ uint8_t *attentionOut,
  __gm__ uint8_t *workspace, const SparseAttentionScoreGeneralTilingData *__restrict tiling, TPipe *tPipe) {
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::SetTiling(const SparseAttentionScoreGeneralTilingData *__restrict tilingData) {
  // copy base params
...
__aicore__ inline void
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::InitInput(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
  ...
  if constexpr (IsSameType<INPUT_T, float>::value) {
    mm1ResPingAddr =
      (dropmaskWorkSpaceLen + this->blockIdx * (mm1TotalOffset * 2 + mm2TotalOffset + pseAlibiOffset)) / sizeof(T);
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::ComputeConstexpr() {
  // 计算轴的乘积
  this->s1S2 = this->tilingData->inputParams.s1Size * this->tilingData->inputParams.s2Size;
  this->gS1D =
    this->tilingData->inputParams.gSize * this->tilingData->inputParams.s1Size * this->tilingData->inputParams.dSize;
  ...
  this->bN2G =
    this->tilingData->inputParams.bSize * this->tilingData->inputParams.n2Size * this->tilingData->inputParams.gSize;
  this->bN2GD = this->bN2G * this->dSize;
  this->n2GS1D = this->tilingData->inputParams.n2Size * this->gS1D;
  this->n2S2D =
    this->tilingData->inputParams.n2Size * this->tilingData->inputParams.s2Size * this->tilingData->inputParams.dSize;
  ...
  if constexpr (hasPse == true) {
    ...
    this->pseInfo.pseEndogenous = (this->pseInfo.pseType == static_cast<int64_t>(PseTypeEnum::PSE_INNER_MUL_ADD_TYPE) ||
                     this->pseInfo.pseType == static_cast<int64_t>(PseTypeEnum::PSE_INNER_MUL_ADD_SQRT_TYPE))
                    ? true
                    : false;
  }
...
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
  ...
  this->tensorABatchSize = this->bBaseSize * this->tilingData->inputParams.n2Size * this->tilingData->inputParams.gSize;
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::CalBatchSize() {
  this->tensorABatchSize = this->bBaseSize * this->tilingData->inputParams.n2Size * this->tilingData->inputParams.gSize;
  this->tensorBBatchSize = this->bBaseSize * this->tilingData->inputParams.n2Size;
}
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::InitBuffer() {
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::SetExtraInfo(SplitBExtraInfo &extraInfo,
                                                                                         int64_t taskId,
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::IterateBmm1(SplitBExtraInfo &extraInfo) {
...
__aicore__ inline void
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::WaitBmm2Result(matmul::Matmul<a2Type, b2Type, T2, bias2Type, MM_CFG> &bmm2) {
...
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
  ...
  if (extraInfo.taskId % 2 == 0) {
    bmm2.template IterateBatch<false, true>(this->mm2ResPing, this->tensorABatchSize, this->tensorBBatchSize, false);
  } else {
    bmm2.template IterateBatch<false, true>(this->mm2ResPong, this->tensorABatchSize, this->tensorBBatchSize, false);
  }
}
...
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::ComputeQCoreOffset(SplitBExtraInfo &extraInfo) {
  // 计算gm上的offset
  int64_t qBOffset = 0;
...
__aicore__ inline int64_t
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::ComputeKVCoreOffset(SplitBExtraInfo &extraInfo) {
  // 计算gm上的offset
  int64_t kvBOffset = 0;
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::GetBmm1Result(SplitBExtraInfo &extraInfo,
  ...
  if (extraInfo.s2AlignSize == this->s2Size) {
    ...
    if (extraInfo.taskId % 2 == 0) {
      DataCopy(
        bmm1ResUb,
        this->mm1ResPing[extraInfo.biN2GoIdx * this->s1Size * this->s2Size + loopIdx * this->s1BaseSize * this->s2Size],
        extraInfo.vecS1BaseSize * this->s2Size);
    } else {
      DataCopy(
        bmm1ResUb,
        this->mm1ResPong[extraInfo.biN2GoIdx * this->s1Size * this->s2Size + loopIdx * this->s1BaseSize * this->s2Size],
        extraInfo.vecS1BaseSize * this->s2Size);
    }
  } else {
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::ProcessVec1(SplitBExtraInfo &extraInfo) {
  ...
  for (uint32_t biN2GoIdx = 0; biN2GoIdx < this->biN2G; biN2GoIdx++) {
    ...
    for (uint32_t loopIdx = 0; loopIdx < this->s1OuterSize; loopIdx++, loopIdxNew++) {
      ...
      if (this->tilingData->inputParams.pseType == static_cast<uint32_t>(PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE)) {
        ...
        pipe_barrier(PIPE_V);
        Muls(stage1PingTensor, stage1PongTensor, static_cast<T>(1.0), extraInfo.vecS1BaseSize * extraInfo.s2AlignSize);
      }
      SetFlag<HardEvent::MTE2_V>(eventIdMte2ToV);
      WaitFlag<HardEvent::MTE2_V>(eventIdMte2ToV);
      ...
      if constexpr (!IsSameType<T, INPUT_T>::value) {
        ...
        if (extraInfo.taskId % 2 == 0) {
          DataCopyPad(
            this->stage1ResPing[biN2GoIdx * this->s1Size * this->s2Size + loopIdx * this->s1BaseSize * this->s2Size],
            stage1CastTensor, dataCopyParams);
        } else {
          DataCopyPad(
            this->stage1ResPong[biN2GoIdx * this->s1Size * this->s2Size + loopIdx * this->s1BaseSize * this->s2Size],
            stage1CastTensor, dataCopyParams);
        }
      } else {
        SetFlag<HardEvent::V_MTE3>(eventIdVToMte3);
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::NzToNd(SplitBNz2NdInfo &nz2NdInfo,
    ...
    for (int64_t i = 0; i < 2; ++i) {
      for (int64_t j = 0; j < innerLoop; ++j) {
        Copy(bmmResUb[outerIndex * outerBmmOffset + j * 128 + i * 8],
             tempUb[outerIndex * outerTempOffset + j * offsetJ + i * 8], this->repeatMaxSize, this->repeatMaxTimes,
             repeatParams);
      }
      if (likely(innerRemain)) {
        Copy(bmmResUb[outerIndex * outerBmmOffset + innerLoop * 128 + i * 8],
             tempUb[outerIndex * outerTempOffset + innerLoop * offsetJ + i * 8], innerRemain * 8, this->repeatMaxTimes,
             repeatParams);
      }
    }
  }
    ...
    for (int64_t i = 0; i < 2; ++i) {
      for (int64_t j = 0; j < innerLoop; ++j) {
        Copy(bmmResUb[outerLoop * outerBmmOffset + j * 128 + i * 8],
             tempUb[outerLoop * outerTempOffset + j * offsetJ + i * 8], this->repeatMaxSize, outerRemain, repeatParams);
      }
      if (likely(innerRemain)) {
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::ProcessVec2(SplitBExtraInfo &extraInfo) {
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::Bmm2ResultDiv(SplitBExtraInfo &extraInfo,
                                                                                          int64_t vec2S1Idx,
  ...
  if constexpr (IsSameType<T, half>::value) {
    ...
    for (int32_t i = 0; i < s1OuterLoop; i++) {
      ...
      if (likely(innerRemain)) {
        Div(bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize], bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize],
            sumCastTensor[sumOffset], innerRemain, repeatMaxTimes, repeatParams);
      }
    }
    if (likely(s1OuterRemain)) {
      ...
      if (likely(innerRemain)) {
        Div(bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize], bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize],
            sumCastTensor[sumOffset], innerRemain, s1OuterRemain, repeatParams);
      }
    }
  } else {
    event_t eventIdMte2ToV = static_cast<event_t>(GetTPipePtr()->FetchEventID(HardEvent::MTE2_V));
    ...
    for (int32_t i = 0; i < s1OuterLoop; i++) {
      ...
      if (likely(innerRemain)) {
        Div(bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize], bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize],
            sumTensor[sumOffset], innerRemain, repeatMaxTimes, repeatParams);
      }
    }
    if (likely(s1OuterRemain)) {
      int32_t innerLoop = this->dSizeAlign16 / repeatMaxSize;
      ...
      if (likely(innerRemain)) {
        Div(bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize], bmm2Res[s1OuterOffset + innerLoop * repeatMaxSize],
            sumTensor[sumOffset], innerRemain, s1OuterRemain, repeatParams);
      }
    }
  }
}
...
__aicore__ inline void
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::Bmm2DataCopyOut(SplitBExtraInfo &extraInfo, int64_t vec2S1Idx,
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::CopyInAttenMask(SplitBExtraInfo &extraInfo,
                                                                                            int64_t maskOffset) {
  if constexpr (hasAtten == true) {
    LocalTensor<uint8_t> attenMaskUb = this->maskTBufPing.template Get<uint8_t>();
    if (this->attenMaskCompressMode == static_cast<uint8_t>(AttenMaskCompressMode::PREFIX_MODE) && maskOffset != -1) {
      pipe_barrier(PIPE_V);
...
__aicore__ inline int64_t
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::ComputeOffsetForCausal(const int64_t &delta, const uint32_t &s1BaseSize,
                                                              const uint32_t &s2BaseSize,
                                                              const uint32_t &attenMaskS2Size) {
  if constexpr (hasAtten == true) {
    if (delta <= 0) {
...
__aicore__ inline int64_t
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::ComputeOffsetForPrefixRectangle(const int64_t &delta, const uint32_t &s2BaseSize,
                                                                       const uint32_t &attenMaskS2Size) {
  if constexpr (hasAtten == true) {
...
__aicore__ inline int64_t
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::ComputeAttenMaskOffset(SplitBExtraInfo &extraInfo) {
  if constexpr (hasAtten == true) {
    ...
    if (this->attenMaskCompressMode == static_cast<uint8_t>(AttenMaskCompressMode::NO_COMPRESS_MODE)) {
      ...
      this->attenMaskOffsetPre =
        this->ComputeOffsetForPrefixRectangle(deltaPre, this->s2Size, this->tilingData->inputParams.attenMaskS2Size);
...
__aicore__ inline int64_t
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::ComputeOffsetForNoCompress(SplitBExtraInfo &extraInfo) {
  if constexpr (hasAtten == true) {
    int64_t bOffset = 0;
    int64_t s1Offset = 0;
    ...
    if (this->tilingData->inputParams.attenMaskShapeType == 0) {  // 0: (B,N2,G,S1,S2)
      ...
      s1Offset = extraInfo.s1oIdx * this->s1BaseSize * this->s2Size;
      biN2GOffset = extraInfo.biN2GoIdx / (this->tilingData->inputParams.n2Size * this->tilingData->inputParams.gSize) *
                    this->s1Size * this->s2Size;
...
__aicore__ inline void
SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                              layout>::AtenmaskBoolCopyIn(LocalTensor<uint8_t> &dstTensor,
                                                          GlobalTensor<uint8_t> &srcTensor, int64_t offset,
                                                          SplitBExtraInfo &extraInfo, int32_t s2Size,
                                                          int64_t totalS2Size) {
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::ComputeAttenMask(SplitBExtraInfo &extraInfo,
                                                                                             LocalTensor<T> &bmm1ResUb,
                                                                                             const uint8_t maskType) {
  if constexpr (hasAtten == true) {
    LocalTensor<uint8_t> attenMaskUb = this->maskTBufPing.template Get<uint8_t>();
...
template <ImplModeEnum implMode, LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, bool isBasicBlock, LayoutMode layout>
__aicore__ inline void SparseAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                     isBasicBlock, layout>::SoftMaxCompute(SplitBExtraInfo &extraInfo,
                                                                                           LocalTensor<T> &srcTensor,
                                                                                           int64_t loopIdx) {
  uint32_t bmm1ResUbShape[] = {static_cast<uint32_t>(extraInfo.vecS1BaseSize),
                               static_cast<uint32_t>(extraInfo.s2AlignSize)};
  uint32_t bmm1ResUbOriShape[] = {static_cast<uint32_t>(extraInfo.vecS1BaseSize), static_cast<uint32_t>(this->s2Size)};
  ...
  LocalTensor<uint8_t> apiTmpBuffer = this->commonTBuf.template Get<uint8_t>();
  pipe_barrier(PIPE_V);
  SoftMaxTiling softmaxSparseTilingData;
...
#endif  // SPARSE_ATTENTION_SCORE_B_H
