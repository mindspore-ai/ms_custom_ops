...
class CustomMlaPreprocess : public InternalKernelMod {
 public:
  ...
  void InitKernelInputsOutputsIndex() override {
    kernel_inputs_index_ = {
      kMlaPreprocessInput1Index,      kMlaPreprocessGamma1Index,       kMlaPreprocessBeta1Index,
 ...
 protected:
  internal_v2::InternalOpPtr CreateKernel(const internal_v2::InputsImmutableInfoList &inputs,
    ...
    internal_v2::MlaPreprocessParam param;
...
REG_GRAPH_MODE_OP(mla_preprocess, ms_custom_ops::CustomMlaPreprocessOpFuncImpl, ms_custom_ops::CustomMlaPreprocess);
