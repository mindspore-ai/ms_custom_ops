...
class CustomMoeGatingGroupTopK : public InternalKernelMod {
 ...
 protected:
  internal_v2::InternalOpPtr CreateKernel(const internal_v2::InputsImmutableInfoList &inputs,
    ...
    internal_v2::MoeGatingGroupTopKParam param;
    ...
    return internal_v2::CreateMoeGatingGroupTopKOp(inputs, outputs, param,
                                                   internal_v2::kInternalMoeGatingGroupTopKOpName);
  }
};
}  // namespace ms_custom_ops
...
class MoeGatingGroupTopKRunner : public InternalPyboostRunner {
 ...
 protected:
  internal_v2::InternalOpPtr CreateKernel(const internal_v2::InputsImmutableInfoList &inputs,
    ...
    return internal_v2::CreateMoeGatingGroupTopKOp(inputs, outputs, param_,
                                                   internal_v2::kInternalMoeGatingGroupTopKOpName);
  }

 private:
  internal_v2::MoeGatingGroupTopKParam param_;
};
...
std::vector<ms::Tensor> npu_moe_gating_group_topk(
  ...
  auto runner = std::make_shared<MoeGatingGroupTopKRunner>(op_name);
...
auto pyboost_moe_gating_group_topk(const ms::Tensor &x, const std::optional<ms::Tensor> &bias, std::optional<int64_t> k,
  ...
  return ms::pynative::PyboostRunner::Call<ms_custom_ops::kNumber3>(ms_custom_ops::npu_moe_gating_group_topk, x, bias,
                                                                    k, k_group, group_count, group_select_mode, renorm,
...
MS_CUSTOM_OPS_EXTENSION_MODULE(m) {
  m.def("moe_gating_group_topk", &pyboost_moe_gating_group_topk, "MoeGatingGroupTopK", pybind11::arg("x"),
        pybind11::arg("bias") = std::nullopt, pybind11::arg("k") = 1, pybind11::arg("k_group") = 1,
        pybind11::arg("group_count") = 1, pybind11::arg("group_select_mode") = 0, pybind11::arg("renorm") = 0,
        pybind11::arg("norm_type") = 0, pybind11::arg("out_flag") = false, pybind11::arg("routed_scaling_factor") = 1.0,
        pybind11::arg("eps") = 1e-20);
}
