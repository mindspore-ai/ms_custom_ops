...
class OPS_API CustomPagedCacheLoadOpFuncImpl : public OpFuncImpl {
 public:
  ShapeArray InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const override {
    ...
    MS_CHECK_VALUE(input_infos[kPCLInputSeqLensIndex]->GetType() == mindspore::TypeId::kNumberTypeInt32,
                   CheckAndConvertUtils::FormatCommMsg(
                    "For PagedCacheLoad, seq_lens dtype must be int32, but got : ",
                    input_infos[kPCLInputSeqLensIndex]->GetType()));
...
class CustomPagedCacheLoad : public InternalKernelMod {
 ...
 protected:
  internal_v2::InternalOpPtr CreateKernel(const internal_v2::InputsImmutableInfoList &inputs,
    ...
    internal_v2::PagedCacheLoadParam param;
...
REG_GRAPH_MODE_OP(paged_cache_load, ms_custom_ops::CustomPagedCacheLoadOpFuncImpl, ms_custom_ops::CustomPagedCacheLoad);
