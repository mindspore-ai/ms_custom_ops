...
enum RingMLAOutputIndex : int { kAttentionOutIdx = 0, kSoftmaxLseOutIdx, kRingMLAOutputNums };
}  // namespace
...
class CustomRingMLA : public InternalKernelMod {
 ...
 private:
  bool RingMLAParamCheck(const internal_v2::RingMLAParam &op_param);
  bool created_flag_{false};
  internal_v2::RingMLAParam param_;
};
