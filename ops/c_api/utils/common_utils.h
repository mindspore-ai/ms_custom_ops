...
// Common function for batch matrix multiplication shape inference
// Used by both batch_matmul and quant_batch_matmul operators
ShapeVector BatchMatMulMakeShape(const ShapeVector x1_shape, const ShapeVector x2_shape,
                                 ...
                                 const std::string &op_name = "BatchMatMul");

// Common function to check if data type is supported for batch_matmul
// According to aclnn documentation:
// - Atlas training series products, Atlas inference series products: support FLOAT16, FLOAT32
// - Atlas A2/A3 series products: support BFLOAT16, FLOAT16, FLOAT32
void CheckBatchMatMulDataType(TypeId dtype, const std::string &op_name = "BatchMatMul");
}  // namespace ms_custom_ops
