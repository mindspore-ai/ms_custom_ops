...
namespace ms_custom_ops {
void apply_rotary_pos_emb_ext_custom(const ms::Tensor &query, const ms::Tensor &key, const ms::Tensor &cos,
...
auto pyboost_apply_rotary_pos_emb_ext(const ms::Tensor &query, const ms::Tensor &key, const ms::Tensor &cos,
                                      const ms::Tensor &sin, const std::string &layout_str,
                                      const std::string &rotary_mode) {
  return ms::pynative::PyboostRunner::Call<ms_custom_ops::kNumber0>(ms_custom_ops::apply_rotary_pos_emb_ext_custom,
                                                                    query, key, cos, sin, layout_str, rotary_mode);
}

MS_CUSTOM_OPS_EXTENSION_MODULE(m) {
  m.def("apply_rotary_pos_emb_ext", &pyboost_apply_rotary_pos_emb_ext, "ApplyRotaryPosEmbExt", pybind11::arg("query"),
