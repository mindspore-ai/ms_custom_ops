...
### Using Custom Passes
   ...
   You can register and use custom fusion passes to optimize graph execution:
   ...
   # Configure MindSpore context
   ms.context.set_context(mode=ms.GRAPH_MODE, device_target="Ascend")

   # Your network will automatically apply the registered pass optimizations
   ```

   For detailed Pass mechanism, architecture design, and development guide, please refer to: [Pass Auto-Registration Documentation](docs/PASS_README_EN.md)

## Reference Documentation

### Internal Documentation

- [Supported ops](docs/op_list.md)
- [Pass Auto-Registration Mechanism](docs/PASS_README_EN.md) - Detailed guide on Pass architecture, development workflow, and best practices
- [Operator implementation guider](docs/ops_develop_guide.md)
