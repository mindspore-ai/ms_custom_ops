...
class DocGenerator:
    ...
    def process_file(self, file_path):
        ...
        if file_name.endswith("_doc"):
            file_name = file_name[ : -4]
        dest_path = os.path.join(self.dest_dir, f"{file_name}_doc.yaml")
...
def main():
    ...
    parser.add_argument("--src_dir", type=str, default="ops", help="Source directory containing Markdown files.")
    parser.add_argument("--dest_dir", type=str, default="build/yaml",
