...
if(DEFINED ENV{MS_CUSTOM_INTERNAL_KERNEL_HOME})
    set(INTERNAL_KERNEL_ROOT_PATH "$ENV{MS_CUSTOM_INTERNAL_KERNEL_HOME}/internal_kernel")
    message(STATUS "Using environment variable MS_CUSTOM_INTERNAL_KERNEL_HOME="
    "$ENV{MS_CUSTOM_INTERNAL_KERNEL_HOME} for internal kernel path")
else()
    set(INTERNAL_KERNEL_ROOT_PATH
    "${CMAKE_SOURCE_DIR}/prebuild/ms_kernels_internal/ms_kernels_internal/internal_kernel")
endif()
...
# =============================================================================
if(DEFINED ENV{MS_CUSTOM_INTERNAL_KERNEL_HOME})
    set(INTERNAL_KERNEL_LIB_PATH "$ENV{MS_CUSTOM_INTERNAL_KERNEL_HOME}/internal_kernel/lib")
    message(STATUS "Using environment variable MS_CUSTOM_INTERNAL_KERNEL_HOME="
    "$ENV{MS_CUSTOM_INTERNAL_KERNEL_HOME} for internal kernel path")
else()
    set(INTERNAL_KERNEL_LIB_PATH
    "${CMAKE_SOURCE_DIR}/prebuild/ms_kernels_internal/ms_kernels_internal/internal_kernel/lib")
endif()
message(STATUS "INTERNAL_KERNEL_LIB_PATH: ${INTERNAL_KERNEL_LIB_PATH}")

# Check for ms_kernels_internal library
find_library(MINDSPORE_INTERNAL_KERNELS_LIB
    NAMES ms_kernels_internal_v2
...
set(MINDSPORE_INTERNAL_KERNELS_LIB ms_kernels_internal_v2)
